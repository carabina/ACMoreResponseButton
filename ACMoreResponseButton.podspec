#
#  Be sure to run `pod spec lint ACMoreResponseButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wangmengnan"
  # s.authors            = { "wangmengnan" => "acbool@lonlife.cn" }
  # s.social_media_url   = "http://twitter.com/wangmengnan"
